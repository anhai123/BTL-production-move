...
const ReturnUnfixedProductToAgentDistribution = () => {
    ...
    warrantyCenterService
      ...
      .then(
        (response) => {
          ...
          warrantyCenterService.getUnfixEventAfterMaintenanceProduct().then(
            (response) => {
  ...
  return (
    <>
      <Table
        ...
        locale={{
          emptyText:
            "Không có sản phẩm nào lỗi, không thể sửa chữa để chuyển về đại lý",
        }}
      />
    </>
  );
};
export default ReturnUnfixedProductToAgentDistribution;
