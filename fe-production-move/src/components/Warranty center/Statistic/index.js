...
import { clickStatisticsProductButton } from "../../../slices/warrantyCenter";
...
const AdvancedSearchForm = () => {
  ...
  useEffect(() => {
    warrantyCenterService.getAllProductStatus().then(
      (response) => {
...
const StaticticInData = () => {
  ...
  const { dataTableStatistic } = useSelector((state) => state.warranty);
