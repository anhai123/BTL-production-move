...
const CssxCategory = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      dataIndex: "ten_danh_muc_cssx",
      key: "ten_danh_muc_cssx",
      width: "50%",
      ...getColumnSearchProps("ten_danh_muc_cssx"),
    },
  ];
  useEffect(() => {
  ...
  const handleCssxCategoryReturnedFromBE = (arrayOfProductCategory) => {
