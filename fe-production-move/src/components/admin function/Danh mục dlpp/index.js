...
const Dlpp = () => {
  ...
  const columns = [
    ...
    {
      title: "Dlpp category name",
      dataIndex: "ten_danh_muc_dlpp",
      key: "ten_danh_muc_dlpp",
      width: "50%",
      ...getColumnSearchProps("ten_danh_muc_dlpp"),
    },
  ];
  const handleDlppCategoryReturnedFromBE = (arrayOfProductCategory) => {
