...
const UnfixProductTransferedToFacility = () => {
  ...
  useEffect(() => {
    facilityService.getProductIncomingToThisFacility().then(
      (response) => {
    ...
    <>
      ...
      >
        <Button
          ...
          loading={loading}
        >
          Xác nhận đã nhận được sản phẩm
        </Button>
      </Space>
      <Table
        columns={columns}
...
export default UnfixProductTransferedToFacility;
